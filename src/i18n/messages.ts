...
const zhCN = {
  ...
  shell: {
    ...
    modals: { files: '我的文件', upload: '上传', meeting: '视频会议', bots: '机器人', botsEmpty: '还没有机器人', miniapps: '小程序', miniappsTab: '我的小程序', oauthClientsTab: 'OAuth 客户端', miniappsEmpty: '还没有小程序', open: '打开', active: '运行中', inactive: '已停用' },
  },
  layout: {
    mainMenu: '主菜单',
  ...
  chat: {
    ...
    groupList: {
      ...
      createFailed: '创建群聊失败',
      joinSuccess: '加入群聊成功',
      // 发现搜索是完全匹配（大小写不敏感的 ILIKE，无通配）或群 ID 精确匹配，
      // 不是子串联想（发现搜索.md:164）。文案必须说出这件事：否则用户输入
      // 「技术」去找「技术交流群」永远返回空，看起来就是搜索坏了——这正是
      // 本轮迁移在消灭的「静默失败」，只不过失败方是产品语义而不是解包。
      enterGroupKeyword: '请输入完整群名或群 ID',
      notFound: '未找到',
      noMatchedGroup: '没有匹配的群聊。群名需完全一致（不区分大小写），也可以直接输入群 ID',
      searchFailed: '搜索群聊失败',
      ...
      joinApprovalLabel: '入群审核',
      joinApprovalRequiredDesc: '需要审核 - 需群主或管理员同意（默认）',
      joinApprovalOpenDesc: '无需审核 - 符合条件的人直接加入',
      ...
      join: '加入',
      searchGroup: '搜索群聊',
      enterGroupKeywordPlaceholder: '输入完整群名或群 ID',
      search: '搜索',
      applyReason: '申请理由',
...
const enUS = {
  ...
  shell: {
    ...
    modals: { files: 'My files', upload: 'Upload', meeting: 'Meetings', bots: 'Bots', botsEmpty: 'No bots yet', miniapps: 'Mini apps', miniappsTab: 'My mini apps', oauthClientsTab: 'OAuth clients', miniappsEmpty: 'No mini apps yet', open: 'Open', active: 'Active', inactive: 'Inactive' },
  },
  layout: {
    mainMenu: 'Main Menu',
  ...
  chat: {
    ...
    groupList: {
      ...
      enterGroupKeyword: 'Please enter the full group name or group ID',
      notFound: 'Not found',
      noMatchedGroup:
        'No group matched. The group name must match exactly (case-insensitive); you can also enter the group ID',
      ...
      loadInvitesFailed: 'Failed to load group invites',
      retry: 'Retry',
      ...
      joinApprovalLabel: 'Join approval',
      joinApprovalRequiredDesc: 'Approval required - owner or admin must agree (default)',
      ...
      enterGroupKeywordPlaceholder: 'Enter the full group name or group ID',
      search: 'Search',
