        ...
        <div className="flex-1 overflow-y-auto px-2">
          {isLoading ? (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">{t('chat.friendList.noFriends')}</p>
              {searchQuery && <p className="text-xs text-muted-foreground mt-1">{t('chat.friendList.tryOtherSearch')}</p>}
            </motion.div>
          ) : (
                  ...
                  >
                    <div className="relative">
                      ...
                      <span
                        ...
                        title={isOnline(friend.user_id) ? t('chat.friendList.online') : t('chat.friendList.offline')}
                      />
                    </div>
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <span className="truncate text-sm font-medium text-foreground">
                          ...
                          {isOnline(friend.user_id) && (
                            <span className="ml-1 text-xs text-primary">{t('chat.friendList.online')}</span>
                          )}
                        </span>
                        {/* 未读计数角标 */}
                        {(() => {
